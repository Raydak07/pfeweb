...
export class AvtacheService {
  ...
  private apiURL = "http://localhost:8000/apiavtache";
  ...
  getAll(): Observable <any> {
    ...
    return this.httpClient.get(this.apiURL + '/avtaches/')
    .pipe(
  ...
  find(id:number): Observable <any> {
    ...
    return this.httpClient.get(this.apiURL + '/avtaches/' + id)
    .pipe(
      catchError(this.errorHandler)
    )
  }
   ...
   */
  delete(id:number){
    return this.httpClient.delete(this.apiURL + '/avtaches/' + id, this.httpOptions)
    .pipe(
      catchError(this.errorHandler)
    )
  }
