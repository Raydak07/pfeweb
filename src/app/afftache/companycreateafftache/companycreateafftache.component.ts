...
@Component({
  selector: 'app-companycreateafftache',
  standalone: true,
imports: [CommonModule, ReactiveFormsModule,CompanyfooterComponent,CompanyheaderComponent,CompanymenuComponent],
  templateUrl: './companycreateafftache.component.html',
  styleUrl: './companycreateafftache.component.css'
})
export class CompanycreateafftacheComponent {
